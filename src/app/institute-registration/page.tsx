    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/5 via-background to-secondary/5 p-4">
      <Card className="w-full max-w-2xl shadow-xl border-t-4 border-primary">
        <CardHeader className="text-center p-8">
          <Building2 className="mx-auto h-12 w-12 text-primary mb-4" data-ai-hint="office building"/>
          <CardTitle className="text-3xl font-bold tracking-tight">Register Your Institute</CardTitle>
